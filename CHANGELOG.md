...
- Do not report illegal private field/method access inlined from a `private inline fun`'s own declaring class ([MP-4829](https://youtrack.jetbrains.com/issue/MP-4829))
